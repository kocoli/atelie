...
const CONF_URL_BASE = "http://localhost/atelie"; // URL base do site, geralmente localhost em desenvolvimento
const CONF_URL_TEST = "http://localhost/atelie"; // URL base do site, geralmente localhost em desenvolvimento


const CONF_DB_HOST = "localhost";
const CONF_DB_NAME = "atelie";
